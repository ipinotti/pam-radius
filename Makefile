...
#
pam_radius_auth.so: pam_radius_auth.o md5.o
	$(LD) $(LDFLAGS) -Bshareable pam_radius_auth.o md5.o -lpam -o pam_radius_auth.so
	#$(LD) $(LDFLAGS) pam_radius_auth.o md5.o -lpam -o pam_radius_auth.so
